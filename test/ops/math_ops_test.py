  ...
  def testReduceLogSumExp(self):
    for dtype in [np.float16, np.float32, np.double]:
      ...
      with test_util.use_gpu():
        ...
        self.assertAllCloseAccordingToType(y_tf_np, y_np)
  ...
  def testRaggedTensor(self):
    for dtype in [dtypes.float16, dtypes.float32, dtypes.double]:
      ...
      with test_util.use_gpu():
        ...
        self.assertAllCloseAccordingToType(y_rt, y_np)
  ...
  def testXlog1pyNoNeg1(self):
    for dtype in [dtypes.float16, dtypes.float32, dtypes.float64]:
      ...
      with test_util.use_gpu():
        ...
        self.assertAllCloseAccordingToType(xlog1py, xtimeslog1py, half_rtol=3e-3)
  ...
  def testXlog1pyWithZeroBroadcast(self):
    for dtype in [dtypes.float16, dtypes.float32, dtypes.float64]:
      ...
      with test_util.use_gpu():
        ...
        self.assertAllCloseAccordingToType(xtimes_log1py, xlog1py_tf_np[1])
